                ...
                <div className={style.tieude}>
                    <div className={style.tieudetrai}>
                        <div className={style.tieudetraitop}>
                            ...
                            <input className={style.tieudeten} onChange={(e)=>tendonvi(e.target.value)} placeholder="Nhập tên đơn vị ......"></input>
                        </div>
                        <div className={style.tieudetraibottom}>
                            <label className={style.tendv}>Sổ:</label>
                            <input className={style.tieudeten} onChange={(e)=>so(e.target.value)} placeholder="Nhập sổ ......"></input>
                        </div>
                    </div>
